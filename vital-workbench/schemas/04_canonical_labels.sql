...
CREATE INDEX IF NOT EXISTS idx_canonical_composite ON home_stuart_gano.mirion_vital_workbench.canonical_labels(sheet_id, item_ref, label_type);
CREATE INDEX IF NOT EXISTS idx_canonical_sheet ON home_stuart_gano.mirion_vital_workbench.canonical_labels(sheet_id);
CREATE INDEX IF NOT EXISTS idx_canonical_label_type ON home_stuart_gano.mirion_vital_workbench.canonical_labels(label_type);
CREATE INDEX IF NOT EXISTS idx_canonical_quality ON home_stuart_gano.mirion_vital_workbench.canonical_labels(quality_score) WHERE quality_score IS NOT NULL;
