...
DEFAULT_CATALOG = os.getenv("DATABRICKS_CATALOG", "your_catalog")
DEFAULT_SCHEMA = os.getenv("DATABRICKS_SCHEMA", "ontos_ml_workbench")
DEFAULT_WAREHOUSE_ID = os.getenv("DATABRICKS_WAREHOUSE_ID", "your-warehouse-id")
DEFAULT_PROFILE = os.getenv("DATABRICKS_CONFIG_PROFILE", "your-profile")
