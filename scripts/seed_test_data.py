...
Usage:
    python scripts/seed_test_data.py --catalog your_catalog --schema ontos_ml_workbench
    python scripts/seed_test_data.py --profile dev --catalog your_catalog --schema ontos_ml_workbench
"""
        ...
        endpoints = [
            {
                ...
                'endpoint_name': 'ontos-defect-classifier-prod',
                'endpoint_type': 'model',
            ...
            },
            {
                ...
                'endpoint_name': 'ontos-maintenance-predictor-prod',
                'endpoint_type': 'model',
            ...
            },
            {
                ...
                'endpoint_name': 'ontos-calibration-advisor-staging',
                'endpoint_type': 'agent',
