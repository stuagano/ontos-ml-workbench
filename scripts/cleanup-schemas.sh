...
echo ""
log "Schema Cleanup - Consolidating to your_catalog.ontos_ml_workbench"
echo ""
...
success "Updated backend/.env to use your_catalog.ontos_ml_workbench"
echo ""
...
echo "     databricks sql -e 'SHOW TABLES IN your_catalog.ontos_ml_workbench;'"
