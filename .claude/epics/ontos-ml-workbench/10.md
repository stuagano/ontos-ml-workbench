...
github: https://github.com/databricks-field-eng/mirion-workspace/issues/10
depends_on: [2]
parallel: true
conflicts_with: []
---
...
```sql
CREATE TABLE ontos_ml.workbench.example_store (
...
ON ontos_ml.workbench.example_store(embedding)
