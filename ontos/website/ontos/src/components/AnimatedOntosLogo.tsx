...
import styles from './AnimatedOntosLogo.module.css';

interface AnimatedOntosLogoProps {
  width?: number;
  height?: number;
  color?: string;
}

const AnimatedOntosLogo: React.FC<AnimatedOntosLogoProps> = ({ 
  width = 300, 
  height = 300,
  color = '#fe5f46'
}) => {
  return (
    <svg
      ...
      width={width}
      height={height}
      viewBox="0 0 270.000000 262.000000"
      preserveAspectRatio="xMidYMid meet"
      className={styles.animatedLogo}
    >
      <g 
        transform="translate(0.000000,262.000000) scale(0.050000,-0.050000)"
        fill="none"
        stroke={color}
        strokeWidth="40"
        strokeLinecap="round"
      ...
      >
        ...
        <path 
          ...
          d="M3241 3425 l1 -95 182 -105 c204 -118 199 -118 211 2 l8 88 -109 63 c-60 34 -114 80 -120 102 -8 32 -27 40 -92 40 l-82 0 1 -95z" 
        />
        <path 
          className={styles.drawPath}
          style={{ animationDelay: '0.6s' }}
          d="M2555 2858 c-47 -27 -95 -123 -95 -189 0 -248 314 -311 378 -76 49 184 -131 354 -283 265z m165 -78 c50 -50 53 -172 7 -223 -84 -93 -203 -1 -180 138 19 119 100 158 173 85z" 
        />
        <path 
          className={styles.drawPath}
          style={{ animationDelay: '0.8s' }}
          d="M1680 2109 c0 -53 14 -85 55 -121 30 -27 90 -80 133 -118 121 -108 217 -102 208 15 -6 82 -10 86 -176 189 -203 126 -220 128 -220 35z" 
        />
        <path 
          className={styles.drawPath}
          style={{ animationDelay: '1s' }}
          d="M1269 4143 l-259 -155 0 -329 0 -329 225 -129 225 -130 0 -166 0 -165 -152 0 -152 0 -117 121 c-103 107 -122 119 -158 100 -55 -30 -52 -64 11 -123 29 -26 70 -73 91 -103 l40 -55 -102 -107 c-97 -102 -99 -108 -64 -140 55 -50 82 -41 213 68 109 90 128 99 222 99 56 0 143 6 192 12 l90 13 18 221 18 221 223 132 224 131 8 90 c11 115 14 112 -91 103 -65 -5 -88 -15 -86 -38 2 -30 -337 -254 -365 -241 -7 3 -87 50 -178 104 l-165 97 0 215 0 215 173 103 c193 116 174 117 392 -12 105 -62 155 -104 155 -129 0 -31 16 -37 91 -37 l91 0 -6 94 c-7 104 -3 101 -417 332 l-131 73 -259 -156z" 
        />
        <path 
          className={styles.drawPath}
          style={{ animationDelay: '1.2s' }}
          d="M3504 4146 l-264 -153 0 -97 0 -96 80 0 c65 0 84 9 99 45 10 25 89 88 181 143 l163 99 108 -59 c60 -32 142 -81 183 -109 l75 -50 1 -206 0 -206 -115 -70 c-115 -70 -115 -70 -115 -168 0 -123 1 -123 220 13 224 139 206 96 189 454 l-14 305 -192 113 c-106 62 -225 131 -264 154 l-71 42 -264 -154z" 
        />
        <path 
          className={styles.drawPath}
          style={{ animationDelay: '1.4s' }}
          d="M4249 2931 c-35 -53 -35 -53 42 -132 l77 -79 -313 0 c-367 0 -340 20 -346 -257 l-5 -209 -232 -138 -232 -137 0 -90 0 -89 80 0 c68 0 84 8 100 50 10 28 28 50 39 50 11 0 85 40 165 89 l146 88 110 -62 c60 -34 140 -81 176 -104 l66 -41 10 -211 10 -211 -175 -99 c-96 -54 -181 -102 -188 -105 -27 -11 -355 200 -365 235 -6 26 -33 39 -93 44 -100 10 -109 0 -92 -112 l13 -85 264 -151 c305 -174 232 -179 599 39 l215 127 0 300 c0 352 20 316 -275 489 l-204 120 -1 155 c0 85 2 161 5 169 7 18 495 25 495 7 0 -8 -23 -36 -51 -62 -58 -54 -58 -125 -2 -136 36 -7 252 183 293 259 14 24 -19 68 -139 187 l-157 156 -35 -54z" 
        />
        <path 
          className={styles.drawPath}
          style={{ animationDelay: '1.6s' }}
          d="M1180 2083 l-190 -116 -6 -178 c-4 -99 -1 -242 6 -320 l13 -141 261 -153 262 -153 62 32 c34 18 159 90 277 161 l215 129 0 87 c0 104 -7 110 -116 95 -63 -9 -84 -20 -84 -47 0 -24 -58 -71 -172 -140 l-172 -104 -83 46 c-46 26 -123 70 -173 99 l-90 53 -6 218 -5 219 110 66 c111 66 111 67 111 165 0 121 10 122 -220 -18z" 
        />
      </g>
    </svg>
  );
...
export default AnimatedOntosLogo;
